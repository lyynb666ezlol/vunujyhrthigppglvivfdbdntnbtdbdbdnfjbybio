...
game:GetService("Workspace").OhioSign.Screen.SurfaceGui.Frame.Population.Text = "lyy";
...
local function addbtn(parent, plr)
	...
	playerbutton.MouseButton1Click:Connect(function()
		...
		viewbutton.Text = ((viewedPlayer == plr) and "退出观看") or "观看"
	end)
end
...
makecharbutton("按Q隐身").MouseButton1Click:Connect(function()
	...
	Sound:Play()
	game:GetService("StarterGui"):SetCore("SendNotification",{["Title"] = "lyy隐身加载成功",["Text"] = "按 "..Keybind.." 开始隐身.（不要再次加载）",["Duration"] = 20,["Button1"] = "知道了"})
...
local cbringframe = makeFrame(scrollingFrame, "把他传送过来", Color3.fromRGB(1, 1, 1))
